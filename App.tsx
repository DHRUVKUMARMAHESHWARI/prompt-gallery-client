...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    {/* Sidebar Container */}
    <div className={`
        fixed left-0 top-0 h-screen bg-[#09090b] border-r border-white/5 flex flex-col z-50 
...
const MainContent = ({ onOpenSidebar }: { onOpenSidebar?: () => void }) => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            <header className="sticky top-0 z-30 backdrop-blur-md bg-black/20 border-b border-white/5 px-4 md:px-8 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
